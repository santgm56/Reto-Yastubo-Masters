...
@endif
			...
			<form class="form w-100" method="GET" action="{{ route('customer.login') }}" data-fastapi-login="true" data-login-channel="customer" data-login-redirect="/customer/dashboard">
